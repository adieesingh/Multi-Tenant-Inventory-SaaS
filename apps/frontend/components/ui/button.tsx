...
function ButtonLink({text ,variant,size,className}:ButtonLinkProps & VariantProps<typeof buttonVariants>) {
  return <Button  variant={variant} size={size} className={"max-w-sx w-full font-bold"}>{text}</Button>
}
